...
import co.sinte.entities.Listas.riesgos.COAGYTerrenoRuta;
 ...
 * @author DESARROLLO
 */
public class COAGYTerrenoRutaDAO {
    ...
    COAGYTerrenoRuta sreturn = null;

    public ArrayList COAGYTerrenoRuta(ArrayList coagyterrenoruta, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    sreturn = new COAGYTerrenoRuta();

                    sreturn.setId(rs.getLong(1));
                    sreturn.setValor(rs.getString(2));

                    coagyterrenoruta.add(sreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COAGYTerrenoRutaDAO.class.getName()).log(Level.SEVERE, null, ex);
