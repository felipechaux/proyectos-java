...
import co.sinte.entities.Listas.riesgos.COAGYHorasTrabajadas;
 ...
 * @author DESARROLLO
 */
public class COAGYHorasTrabajadasDAO {
    ...
    COAGYHorasTrabajadas sreturn = null;

    public ArrayList COAGYHorasTrabajadas(ArrayList coagyhorastrabajadas, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    sreturn = new COAGYHorasTrabajadas();

                    sreturn.setId(rs.getLong(1));
                    sreturn.setValor(rs.getString(2));

                    coagyhorastrabajadas.add(sreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COAGYHorasTrabajadasDAO.class.getName()).log(Level.SEVERE, null, ex);
