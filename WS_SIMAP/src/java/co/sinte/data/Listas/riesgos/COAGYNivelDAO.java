...
import co.sinte.entities.Listas.riesgos.COAGYNivel;
import co.sinte.entities.Listas.riesgos.COAGYNivel;
...
public class COAGYNivelDAO {
    ...
    COAGYNivel sreturn = null;

    public ArrayList COAGYNivel(ArrayList coagynivel, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    sreturn = new COAGYNivel();

                    sreturn.setId(rs.getLong(1));
                    sreturn.setValor(rs.getString(2));

                    coagynivel.add(sreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COAGYNivelDAO.class.getName()).log(Level.SEVERE, null, ex);
