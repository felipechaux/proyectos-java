...
import co.sinte.entities.Listas.riesgos.COAGYHorasEquipoTripulacionPc;
 ...
 * @author DESARROLLO
 */
public class COAGYHorasEquipoTripulacionPcDAO {
    ...
    COAGYHorasEquipoTripulacionPc hereturn = null;

    public ArrayList COAGYHorasEquipoTripulacionPc(ArrayList coagyhorasequipo, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    hereturn = new COAGYHorasEquipoTripulacionPc();
                ...
                Logger.getLogger(COAGYHorasEquipoTripulacionPcDAO.class.getName()).log(Level.SEVERE, null, ex);
