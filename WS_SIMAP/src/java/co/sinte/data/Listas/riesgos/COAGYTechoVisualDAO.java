...
import co.sinte.entities.Listas.riesgos.COAGYTechoVisual;
 ...
 * @author DESARROLLO
 */
public class COAGYTechoVisualDAO {
    ...
    COAGYTechoVisual sreturn = null;

    public ArrayList COAGYTechoVisual(ArrayList coagytechovisual, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    sreturn = new COAGYTechoVisual();

                    sreturn.setId(rs.getLong(1));
                    sreturn.setValor(rs.getString(2));

                    coagytechovisual.add(sreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COAGYTechoVisualDAO.class.getName()).log(Level.SEVERE, null, ex);
