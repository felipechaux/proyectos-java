...
import co.sinte.entities.Listas.riesgos.COAGYDescanso;
...
public class COAGYDescansoDAO {
    ...
    COAGYDescanso sreturn = null;

    public ArrayList COAGYDescanso(ArrayList coagydescanso, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    sreturn = new COAGYDescanso();

                    sreturn.setId(rs.getLong(1));
                    sreturn.setValor(rs.getString(2));

                    coagydescanso.add(sreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COAGYDescansoDAO.class.getName()).log(Level.SEVERE, null, ex);
