...
import co.sinte.entities.Listas.riesgos.COAGYTerrenoAproximacion;
 ...
 * @author DESARROLLO
 */
public class COAGYTerrenoAproximacionDAO {
    ...
    COAGYTerrenoAproximacion sreturn = null;

    public ArrayList COAGYTerrenoAproximacion(ArrayList coagyterrenoaproximacion, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    sreturn = new COAGYTerrenoAproximacion();

                    sreturn.setId(rs.getLong(1));
                    sreturn.setValor(rs.getString(2));

                    coagyterrenoaproximacion.add(sreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COAGYTerrenoAproximacionDAO.class.getName()).log(Level.SEVERE, null, ex);
