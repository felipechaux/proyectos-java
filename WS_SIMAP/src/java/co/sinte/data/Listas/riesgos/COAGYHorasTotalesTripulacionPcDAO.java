 ...
 * @author DESARROLLO
 */
public class COAGYHorasTotalesTripulacionPcDAO {
    ...
    COAGYHorasTotalesTripulacionPc htreturn = null;

    public ArrayList COAGYHorasTotalesTripulacionPc(ArrayList coagyhorastotales, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    htreturn = new COAGYHorasTotalesTripulacionPc();
                ...
                Logger.getLogger(COAGYHorasTotalesTripulacionPcDAO.class.getName()).log(Level.SEVERE, null, ex);
