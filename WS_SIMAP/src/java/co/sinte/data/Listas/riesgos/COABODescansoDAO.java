...
import co.sinte.entities.Listas.riesgos.COABODescanso;
...
public class COABODescansoDAO {
    ...
    COABODescanso dreturn = null;

    public ArrayList COABODescanso(ArrayList coabodescanso, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    dreturn = new COABODescanso();

                    dreturn.setId(rs.getLong(1));
                    dreturn.setValor(rs.getString(2));

                    coabodescanso.add(dreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COABODescansoDAO.class.getName()).log(Level.SEVERE, null, ex);
