...
import co.sinte.entities.Listas.riesgos.COAGYTerrenoDespegue;
 ...
 * @author DESARROLLO
 */
public class COAGYTerrenoDespegueDAO {
    ...
    COAGYTerrenoDespegue sreturn = null;

    public ArrayList COAGYTerrenoDespegue(ArrayList coagyterrenodespegue, MensajeRespuesta respuesta) {
        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    sreturn = new COAGYTerrenoDespegue();

                    sreturn.setId(rs.getLong(1));
                    sreturn.setValor(rs.getString(2));

                    coagyterrenodespegue.add(sreturn);

                }

            } catch (SQLException ex) {
                Logger.getLogger(COAGYTerrenoDespegueDAO.class.getName()).log(Level.SEVERE, null, ex);
