...
public class AdmPersonas {
    ...
    @XmlElement
    private String nombre,primerApellido,segundoApellido,primerNombre,segundoNombre,cedula,grupoSanguineo,rh,estadoCivil,genero;
    @XmlElement
    private Long estatura,peso;
    @XmlElement
    private String pid,categoria;
    @XmlElement
    ...
    @XmlElement
    private String hojaVida,escalafon;
    @XmlElement
    private Long curso,idPais,idDepartamento,idMunicipio;
    @XmlElement
    private String lugar,usuarioCreador;
    @XmlElement
