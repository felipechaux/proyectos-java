        ...
        if (con != null) {
            try {
                ...
                while (rs.next()) {
                    ...
                    areturn.setReposicion(rs.getString(11));
                    areturn.setFecha(rs.getString(12));
